  ...
  return (
    <div className="Home ">
      ...
      <div className="moreCards ml-10">
        <TitleCards title={"Popular nf movies"} category={"popular"} />
        <TitleCards title={"Top Rated nfm"} category={"top_rated"} />
        <TitleCards title={"Comming Soon in 2026"} category={"upcoming"} />
      </div>
    </div>
  );
};
